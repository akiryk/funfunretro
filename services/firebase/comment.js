 ...
 */
exports.getCommentsByUserId = async (userName) => {
  try {
...
exports.getCommentsByBoardId = async (id) => {
  try {
...
exports.getCommentsByColumnId = async (columnId) => {
  try {
...
exports.createComment = async (input, createdBy) => {
...
exports.updateComment = async (input, userName, isAdmin) => {
  const { id, text } = input;
...
exports.deleteComment = async (id, userName, isAdmin) => {
  try {
    const commentRef = db.doc(`/comments/${id}`);
    const commentDoc = await commentRef.get();
 ...
 */
exports.likeComment = async (input, userName) => {
 ...
 */
exports.unlikeComment = async (input, userName) => {
  // Get commentId and boardId from the input
  const { id: commentId, boardId } = input;
